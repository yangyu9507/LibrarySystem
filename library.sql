...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '系统管理员表';
...
INSERT INTO `admin`
    (`username`, `password`)
VALUES
    ('admin', 'e7ef63bc4c950228aa049fc02d2ec291'),
    ('root', 'e7ef63bc4c950228aa049fc02d2ec291');
...
CREATE TABLE `announcement` (
    ...
    `detail` varchar(2000) DEFAULT NULL COMMENT '公告内容',
    `publish_date` datetime DEFAULT NULL COMMENT '发布日期',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '公告表';

-- ----------------------------
-- Records of announcement
-- ----------------------------
INSERT INTO `announcement`
    (`id`, `title`, `detail`, `publish_date`)
VALUES
    (1, '图书系统开始建设', '图书系统开始建设', '2023-06-02 22:28:31'),
    (2, '图书系统正在建设', '图书系统正在建设，冲鸭', '2023-06-02 08:29:40'),
    (3, '图书管理系统基本建成', '庆祝图书管理系统基本建成', '2023-06-09 16:43:18');
...
CREATE TABLE `books` (
    ...
    `library_id` int(20) DEFAULT NULL COMMENT '存放的图书馆',
    `sort_id` int(30) DEFAULT NULL COMMENT '分类编号',
    `position` varchar(50) DEFAULT NULL COMMENT '存放位置',
    `status` smallint(6) DEFAULT NULL COMMENT '是否借出',
    `description` varchar(2000) DEFAULT NULL COMMENT '书籍描述',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '书籍表';
...
CREATE TABLE `book_sort` (
      ...
      PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '书籍分类表';
...
CREATE TABLE `borrow_books` (
    `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
    `card_id` int(20) DEFAULT NULL COMMENT '借阅证编号',
    `book_id` int(20) DEFAULT NULL COMMENT '书籍编号',
    `borrow_date` datetime DEFAULT NULL COMMENT '借书日期',
    `end_date` datetime DEFAULT NULL COMMENT '限制日期',
    `return_date` datetime DEFAULT NULL COMMENT '归还日期',
    `illegal` varchar(200) DEFAULT NULL COMMENT '违规描述',
    `manager_id` varchar(20) DEFAULT NULL COMMENT '处理人编号',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '借书记录表';
...
VALUES
    (20, '1805010202', '1', '2023-06-11 09:37:10', '2023-06-12 09:37:18', '2023-06-11 09:48:07', '', 'chen'),
    (21, '1805010206', '5', '2023-04-08 09:37:40', '2023-06-08 09:38:14', '2023-06-11 10:50:07', '已逾期3天', 'chen'),
    (22, '1805010207', '1', '2023-06-11 09:47:44', '2023-08-10 09:47:52', '2023-06-11 09:50:07', '', 'chen'),
    (24, '1805010202', '1', '2023-06-02 09:55:04', '2023-06-03 09:55:16', '2023-06-11 09:56:02', '已逾期8天', 'chen'),
    (25, '1805010204', '2', '2023-06-11 09:59:42', '2023-08-10 09:59:47', '2023-06-11 10:00:17', '', 'chen'),
    (26, '1805010202', '1', '2023-06-09 10:01:13', '2023-06-10 10:01:48', '2023-06-11 10:07:29', '超期一天', 'chen'),
    (27, '1805010202', '5', '2023-06-08 10:12:18', '2023-06-09 10:12:27', '2023-06-11 10:13:36', '已逾期2天', 'chen'),
    (28, '1805010204', '2', '2023-04-07 10:12:28', '2023-06-06 10:12:41', null, null, null),
    (29, '1805010202', '6', '2023-06-11 08:19:56', '2023-06-12 08:20:07', null, null, null);
...
CREATE TABLE `borrow_card` (
    ...
    `reader` varchar(20) DEFAULT NULL COMMENT '借阅者姓名',
    `rule_id` int(11) DEFAULT NULL COMMENT '规则编号',
    `status` smallint(6) DEFAULT NULL COMMENT '状态 0注销，1正常',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1805010220 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '借阅证表';
...
VALUES
    (1805010202, 'root', '老王', '7', '1'),
    (1805010203, 'root', '黄白白', '2', '0'),
    (1805010204, 'root', '黄土', '1', '1'),
    (1805010205, '1234', '白云', '1', '1'),
    (1805010206, '111', '月', '6', '1'),
    (1805010207, 'admin', '明月', '1', '1'),
    (1805010208, 'admin', '明月复苏', '1', '1'),
    (1805010210, 'yue', '张沙', '1', '1'),
    (1805010211, 'mingming', '星星', '1', '1'),
    (1805010212, 'admin', '明月', '1', '1'),
    (1805010213, 'chen', '辰', '1', '1'),
    (1805010214, '1234', '小红', '1', '1'),
    (1805010217, '赵雪', '赵雪', '2', '1'),
    (1805010219, '1234', '测试', '1', '0');
...
CREATE TABLE `library` (
    ...
    `name` varchar(20) DEFAULT NULL COMMENT '图书馆名',
    `description` varchar(1000) DEFAULT NULL COMMENT '描述',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '图书馆表';
...
CREATE TABLE `manager` (
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '图书管理员表';
...
CREATE TABLE `message` (
    `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
    `card_id` int(20) DEFAULT NULL COMMENT '借阅证编号',
    `detail` varchar(1000) DEFAULT NULL COMMENT '留言内容',
    `public_date` datetime DEFAULT NULL COMMENT '留言日期',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT '留言表';

-- ----------------------------
-- Records of message
-- ----------------------------
INSERT INTO `message`
    (`id`, `card_id`, `detail`, `public_date`)
VALUES
    (1, '1805010201', '冲鸭，一起来看书', '2023-06-01 23:11:59'),
    (2, '1805010202', '我爱学习', '2023-05-29 23:12:03'),
    (3, '1805010202', '图书馆的书质量很好，图书管理员态度非常好，系统管理员也非常热心，太棒了', '2023-06-04 23:12:24'),
    (6, '1805010202', '咋回事', '2023-06-12 08:34:18');
...
CREATE TABLE `rules` (
    `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
    `borrow_num` int(10) DEFAULT NULL COMMENT '限制借阅数量',
    `limit_day` int(10) DEFAULT NULL COMMENT '限制借阅天数',
    `borrow_library` varchar(20) DEFAULT NULL COMMENT '图书超期每天费用',
    `overtime_fee` float(10,3) DEFAULT NULL COMMENT '超期费用',
    PRIMARY KEY (`id`)
